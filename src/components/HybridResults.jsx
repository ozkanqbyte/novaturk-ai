            ...
            <div className={`rounded-2xl p-4 sm:p-5 border transition-all ${
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-xs sm:text-sm font-bold tracking-tight flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] opacity-50 font-normal">(AI Tahmini — gerçek kullanıcı yorumu değildir)</span>
                    </h4>
                  </div>
                </div>

                {halkNeDiyor.isAiGenerated && (
                  <span className="text-[10px] px-2 py-0.5 rounded-md border border-amber-500/25 bg-amber-500/10 text-amber-400 shrink-0 hidden sm:inline-block">
                    ⚠️ AI tarafından üretildi
                  </span>
                )}
              </div>
              ...
              {halkNeDiyor.consensus && (
                <div className={`p-2.5 rounded-xl border flex items-center gap-2.5 text-xs ${
                  ...
                  <span><strong>AI Değerlendirmesi:</strong> {halkNeDiyor.consensus}</span>
                </div>
              )}
            </div>
          )}
